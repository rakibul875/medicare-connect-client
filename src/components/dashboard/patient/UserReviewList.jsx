            ...
            >
              <div>
                <div className="flex items-start justify-between border-b border-gray-50 pb-3 mb-4">
                  <div className="flex items-center gap-3">
                    <img
                      src={item.userImage || "https://via.placeholder.com/150"}
                      alt={item.doctorName}
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-50/60 mt-auto">
                ...
                <button
                  ...
                  className="bg-sky-50 text-sky-600 hover:bg-sky-100 text-xs font-bold px-4 py-1.5 rounded-xl transition-all cursor-pointer flex items-center gap-1.5"
                >
                  <svg
