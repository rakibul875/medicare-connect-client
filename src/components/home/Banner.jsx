      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center space-x-2 bg-[#006694]/10 text-[#006694] px-4 py-1.5 rounded-full text-xs font-semibold tracking-wide"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          >
            <Link
              href="/find-doctors"
              className="bg-[#149ddd] hover:bg-[#1080b5] text-white font-semibold px-6 py-3.5 rounded-xl shadow-lg shadow-[#149ddd]/20 flex items-center space-x-2 transition-all group active:scale-95"
            >
              <span>Find a Doctor</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button className="bg-white hover:bg-gray-50 text-gray-800 font-semibold px-6 py-3.5 rounded-xl shadow-md border border-gray-100 flex items-center space-x-2 transition-all active:scale-95">
              <span>Book Appointment</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <motion.div
            variants={containerVariants}
            className="grid grid-cols-4 gap-3 pt-6 max-w-lg"
          >
            {stats.map((stat, idx) => (
              <motion.div
                key={idx}
                ...
                className="bg-white/80 p-3 rounded-xl border border-gray-100 shadow-sm text-center transition-shadow hover:shadow-md cursor-default"
              >
                <div className="text-lg sm:text-xl font-bold text-gray-900 flex items-center justify-center space-x-0.5">
        ...
        <div className="relative flex justify-center lg:justify-end w-full">
          ...
          <motion.div
            ...
            className="relative rounded-[2.5rem] overflow-hidden shadow-2xl w-full max-w-[500px] aspect-[4/3] sm:aspect-square lg:aspect-[5/4]"
          >
            <Image
              src={BannerImage}
              alt="Healthcare Professional Team Platform"
          ...
          <motion.div
            ...
            className="absolute -bottom-5 left-4 sm:left-10 bg-white/90 backdrop-blur-md px-5 py-3 rounded-2xl shadow-xl border border-white/50 flex items-center space-x-3 cursor-default"
          >
            <div className="bg-[#014d34]/10 p-2 rounded-xl text-[#014d34]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
