  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white/80 backdrop-blur-md">
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute w-16 h-16 rounded-full border-4 border-transparent border-l-cyan-400 border-r-blue-500 opacity-80" style={{ animation: 'spin 1.5s linear infinite reverse' }}></div>
